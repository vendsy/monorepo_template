...
import com.tray.service.orders.controller.OrdersController;
import com.tray.service.orders.controller.TestApi;
import com.tray.service.orders.controller.TestController;
import com.tray.webpieces.server.filter.routes.JsonFilterRoutes;
import com.tray.webpieces.server.inject.module.CompanyModule;
...
public class ProdServerMeta implements WebAppMeta {
    ...
    public List<Module> getGuiceModules() {
		return Lists.newArrayList(
				new GuiceModule(),
				new CompanyModule(pluginConfig.getCmdLineArguments())
		);
	}
    ...
    public List<Routes> getRouteModules() {
		return Lists.newArrayList(
				...
				new RESTApiRoutes(OrdersApi.class, OrdersController.class),
				new RESTApiRoutes(TestApi.class, TestController.class)
				);
	}
	...
	public List<Plugin> getPlugins() {
		...
		return Lists.newArrayList(
				...
				new JacksonPlugin(new JacksonConfig().setPackageFilterPattern("com\\.tray\\.service\\.[a-z]+\\.controller\\..*")),
