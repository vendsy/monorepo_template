...
public class MyHtmlTagCreator implements HtmlTagCreator {
	...
	public List<Tag> createTags() {
		...
		tags.add(new CustomTag("/com/tray/service/orders/web/tags/mytag.tag"));
		tags.add(new IdTag(converter, "/com/tray/service/orders/web/tags/id.tag"));
		
		//you can also override(subclass or whatever) any tag by replacing it in the map
		//This replaces the field tag
		//put(new FieldTag(converter, "/com/tray/service/orders/base/tags/field.tag"));
