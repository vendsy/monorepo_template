...
import com.tray.webpieces.server.dev.CompanyProdServerForIDE;
 ...
 */
public class ProdServerForIDE extends CompanyProdServerForIDE {
	...
	public ProdServerForIDE(boolean usePortZero) {
		super(TrayService.CONSUMER.getServiceName(), usePortZero);
	}

	@Override
	protected CompanyServer createServer(Module platformOverrides, ServerConfig config, String ... args) {
