...
import com.tray.service.consumer.controller.OrdersForwardController;
...
public class ProdServerMeta implements WebAppMeta {
    ...
    public List<Routes> getRouteModules() {
		return Lists.newArrayList(
				...
				new RESTApiRoutes(TrayOrdersApi.class, OrdersForwardController.class)
				);
	}
	...
	public List<Plugin> getPlugins() {
		...
		return Lists.newArrayList(
				...
				new JacksonPlugin(new JacksonConfig().setPackageFilterPattern("com.tray.service.*")),
